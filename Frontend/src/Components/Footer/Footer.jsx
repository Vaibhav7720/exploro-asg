        ...
        <Row>
          ...
          <Col lg="3">
            ...
            <ListGroup className="footer__quick-links">
              ...
              <ListGroupItem className="ps-0 border-0 d-flex flex-column flex-md-row align-items-md-center gap-3">
                ...
                <p className="mb-0">
                  <Link to="tel:9876543210">+91 9997690443</Link>
                </p>
              </ListGroupItem>
              ...
              <ListGroupItem className="ps-0 border-0 d-flex flex-column flex-md-row align-items-md-center gap-3">
                ...
                <p className="mb-0">Hathras, Uttar Pradesh, India</p>
              </ListGroupItem>
            </ListGroup>
          </Col>
          ...
          <Col lg="12" className="text-center pt-5">
            <p className="copyright">
              ...
              <Link to="https://www.linkedin.com/in/vaibhav-varshney-821760224/">
                Vaibhav
              </Link>
            </p>
          </Col>
